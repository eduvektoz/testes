...
2. Use WebFetch para buscar o feed XML
3. Extraia títulos e datas dos últimos 7 dias
4. Aplique o filtro ICP
5. Marque os relevantes

Se `fontes.md` não tiver canais configurados (apenas comentários ou seção vazia), pule esta etapa e informe ao final.

### Etapa 2 — Web search por keywords

Calcule a data de 7 dias atrás com base na data atual. Execute buscas com o filtro `after:AAAA-MM-DD` para cada keyword:
...
Substitua `AAAA-MM-DD` pela data calculada. Inclua também as keywords adicionais de `fontes.md`.
...
Para cada item `[CONTEÚDO]`, faça append em `projects/criacao-de-conteudo/backlog-temas.md`:
