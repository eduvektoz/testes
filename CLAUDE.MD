...
Antes de criar qualquer material visual (slides, proposta, banner, apresentação, material de apoio), verificar qual identidade usar:

- Se o contexto for claro → sugerir a identidade adequada e confirmar com Eduardo antes de executar
- Se houver ambiguidade → perguntar: "Usar qual identidade visual?"

### Disponíveis

| ID | Uso | Arquivo de referência |
|----|-----|----------------------|
| `Vektoz` | Propostas comerciais, marketing, materiais institucionais, banners | `context/brand.md` |
| `Treinamentos` | Slides e materiais educacionais de treinamentos sobre IA | *(a criar)* |

### Assets da Vektoz

Logos, fontes Inter e paleta em `context/assets/`.
